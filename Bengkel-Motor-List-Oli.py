# import library
from os import popen, system, __name__
import time
...
def inputangka(angka):
    while True:
        try:
            angka = int(input(">> Masukkan Jumlah Belanjaan : "))
        except:
...
def inputjumlah(angka):
    while True:
        try:
            angka = int(input(">> Masukkan Jumlah Liter     : "))
        except:
            print("\nWARNING : Masukkan Input Berupa Angka!!\n")
        else:
            return angka
...
def inputhuruf(huruf):
      while(huruf != "a" and huruf != "b" and huruf != "c" and huruf != "d" and huruf != "e"):
        ulang = input(">> Masukkan Kode List Barang : ")
...
while True:   
    ...
    user = inputangka(">> Masukkan Total Belanjaan : ")

    # validasi inputan tidak boleh <= 0
    while(user <= 0):

         print("\nWARNING : Kurang Dari 0 Tidak Diperbolehkan!!\n")
         user = inputangka(">> Masukkan Jumlah Belanjaan   : ")
    ...
    while(i <= user):
        ...
        print()
        inpt_kode   = inputhuruf(">> Masukkan Kode List Barang : ")
        sts = inpt_kode in kode
        while(sts == True):

            qty     = inputjumlah(">> Masukkan Jumlah Liter     : ")
            while(qty <= 0):

                print("\nWARNING : Kurang Dari 0 Tidak Diperbolehkan!!\n")
                qty = inputangka(">> Masukkan Jumlah Liter     : ")
